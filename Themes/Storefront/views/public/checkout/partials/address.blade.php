<div id="address" class="tab-pane active" role="tabpanel">
    <div class="box-wrapper address clearfix">
                ...
                <div>
                    <div class="create-account">
                        <div class="checkbox" style="display: none;">
                            ...
                            <input type="checkbox" name="create_an_account" checked id="create-an-account"
                                   value="1" {{ old('create_an_account') ? 'checked' : '' }}>
        ...
        <div class="checkbox ship-to-a-different-address">
            ...
            <input type="checkbox" name="ship_to_a_different_address" id="ship-to-a-different-address"
                   value="1" {{ old('ship_to_a_different_address') ? 'checked' : '' }}>
