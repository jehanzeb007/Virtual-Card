<div class="billing-address clearfix">
    ...
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('billing.first_name') ? 'has-error': '' }}">
            ...
            <input type="text" name="billing[first_name]" value="{{ old('billing.first_name',Auth::check()?Auth::user()->first_name:'') }}" class="form-control" id="billing-first-name">
    ...
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('billing.last_name') ? 'has-error': '' }}">
            ...
            <input type="text" name="billing[last_name]" value="{{ old('billing.last_name',Auth::check()?Auth::user()->last_name:'') }}" class="form-control" id="billing-last-name">
    ...
    <div class="col-md-12">
        <div class="form-group {{ $errors->has('billing.address_1') ? 'has-error': '' }}">
            ...
            <input type="text" name="billing[address_1]" value="{{ old('billing.address_1',Auth::check()?Auth::user()->user_info->street_address_1:'')}}" class="form-control" id="billing-address-1">
    ...
    <div class="col-md-12">
        <div class="form-group {{ $errors->has('billing.address_2') ? 'has-error': '' }}">
            ...
            <input type="text" name="billing[address_2]" value="{{ old('billing.address_2',Auth::check()?Auth::user()->user_info->street_address_2:'')}}" class="form-control" id="billing-address-2">
        ...
        <div class="form-group {{ $errors->has('billing.country') ? 'has-error': '' }}">
            ...
            <select name="billing[country]" class="custom-select-black" id="billing-country">
                @foreach ($countries as $code => $name)
                    <option value="{{ $code }}" {{ old('billing.country','DO') === $code ? 'selected' : '' }}>
                        {{ $name }}
                    </option>
                @endforeach
            </select>
