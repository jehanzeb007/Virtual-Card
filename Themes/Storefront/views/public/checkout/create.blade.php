...
@section('content')
    <div class="container">
        <section class="checkout">
            ...
            @endif
            <form method="POST" action="{{ route('checkout.store') }}" id="checkout-form" autocomplete="off">
                {{ csrf_field() }}
                <div>
                    <div class="col-md-8">
                        <div class="wizard">
                            <div class="wizard-inner">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    <li role="presentation" class="address-tab active">
                                        <a href="#address" data-toggle="tab" aria-controls="step1" role="tab"
                                           data-step="1">
                                            {{ trans('storefront::checkout.address') }}

                                            <span class="round-tab"><i class="fas fa-map-marker-alt"
                                                                       aria-hidden="true"></i></span>
                                        </a>
                                    </li>

                                    <li role="presentation" class="disabled payment-tab">
                                        <a href="#payment" data-toggle="tab" aria-controls="step2" role="tab"
                                           data-step="2">
                                            {{ trans('storefront::checkout.payment') }}

                                            <span class="round-tab"><i class="fas fa-dollar-sign"
                                                                       aria-hidden="true"></i></span>
                                        </a>
                                    </li>

                                    <li role="presentation" class="disabled confirm-tab">
                                        <a href="#confirm" data-toggle="tab" aria-controls="step3" role="tab"
                                           data-step="3">
                                            {{ trans('storefront::checkout.confirm') }}

                                            <span class="round-tab"><i class="fa fa-check"
                                                                       aria-hidden="true"></i></span>
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <div class="cart-total">
                                ...
                                <div class="checkout-terms checkbox">
                                    ...
                                    <label for="terms-and-conditions">
                                        {{ trans('storefront::checkout.i_agree_to_the') }} <a
                                            href="{{ $termsPageURL }}">{{ trans('storefront::checkout.terms_and_conditions') }}
                                            .</a>
                                    </label>
                                </div>
                                <button type="submit"
                                        class="btn btn-success-checkout btn-checkout btn-checkout-success {{ $cart->hasNoAvailableShippingMethod() ? 'disabled' : '' }}"
