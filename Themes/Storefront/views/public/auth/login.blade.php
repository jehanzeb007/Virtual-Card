...
@section('content')
    <div class="loginContainer"
         style="background-image: url('{{ v(Theme::url('public/new/images/loginRegister/bg-log-in.jpg'))}}')">
        <div class="container">
                    ...
                    {{--<div class="form-box-left">
                                <div class="icon-box">
                                    <span class="icon-wrapper">
                                        <img src="{{ v(Theme::url('public/new/images/white_logo.png'))}}">
                                    </span>
                                </div>
                            </div> --}}
                    <div class="form-box-right">
                        <form method="POST" action="{{ route('login.post') }}" class="login-form clearfix">
							...
							<span class="input-group-addon">
                                <img src="{{ v(Theme::url('public/new/images/user.png'))}}">
                            </span>
                                        <input type="text" name="username" value="{{ old('email') }}"
                                               class="form-control" id="username" placeholder="Email or Username"
                                               autofocus>
                                ...
                                <div class="form-group {{ $errors->has('password') ? 'has-error': '' }}">
                                    <div class="input-group">
<span class="input-group-addon">
                                <img src="{{ v(Theme::url('public/new/images/key.png'))}}">
                            </span>
