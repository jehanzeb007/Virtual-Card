...
@section('content')
    <div class="resetFormMain">
        <div class="form-wrapper resetForm">
                        ...
                        <form method="POST" action="{{ route('reset.complete.post', [$user->email, $code]) }}">
                            ...
                            <div class="form-group {{ $errors->has('new_password') ? 'has-error': '' }}">
                                <input type="password" name="new_password" class="form-control"
                                       placeholder="{{ trans('user::attributes.users.new_password') }}" autofocus>
                            ...
                            <div class="form-group {{ $errors->has('new_password_confirmation') ? 'has-error': '' }}">
                                <input type="password" name="new_password_confirmation" class="form-control"
                                       placeholder="{{ trans('user::attributes.users.new_password_confirmation') }}">
