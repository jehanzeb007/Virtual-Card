        ...
        <div class="personal-information clearfix">
            ...
            <div class="col-md-6">
                <div class="form-group {{ $errors->has('customer_email') ? 'has-error': '' }}">
                    ...
                    <input type="text" name="customer_email" class="form-control" id="customer-email" value="{{ old('customer_email',Auth::check()?Auth::user()->email:'')}}">
                ...
                <div class="col-md-6">
                    <div class="create-account clearfix">
                        <div class="checkbox" style="display: none;">
                            ...
                            <input type="checkbox" name="create_an_account" checked id="create-an-account" value="1" {{ old('create_an_account') ? 'checked' : '' }}>
