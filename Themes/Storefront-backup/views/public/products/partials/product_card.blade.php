<div class="archive-single-post product-card">
                    ...
                    <a href="{{ route('products.show', $product->slug) }}" class="thumb-container" is_video="false" style="background: url('{{ $product->base_image->path }}'); background-size: cover;"></a>

                    <div class="blog-text-container">
                        <p>From {{ product_price($product) }}</p>
                        <span class="text-center">
        					<a class="blog-text-container__cat btn btn-purple btn-round" href="{{ route('products.show', $product->slug) }}">
        						buy now
        					</a>
        				</span>
