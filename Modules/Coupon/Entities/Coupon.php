...
class Coupon extends Model
{
    ...
    {
        return $this->user_roles ? $this : (object) [];
    }
    public function userRoles()
    {
        return ! is_null($this->user_roles) && !empty($this->user_roles) ? $this->user_roles : [];
    }
    ...
    public function valid()
    {
        ...
        if(!empty($this->userRoles())){
            if(auth()->check()){
                $current_user_role = auth()->user()->hasRoleIds($this->userRoles());
